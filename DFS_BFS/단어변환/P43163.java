public class P43163 {
  ...
  static int answer;                        //최소 단계
  static boolean[] used;                    //단어를 사용 중인지를 판단하는 visited와 같은 역할을 하는 배열
  ...
  public static boolean check(String presentWord, String nextWord) { //현재의 단어와 다음 단어가 바뀔 조건에 일치하는가를 체크
